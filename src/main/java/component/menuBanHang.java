...
public class menuBanHang extends javax.swing.JPanel {
        ...
        listMenu.addEventSelectedMenu(new eventSelected() {
            ...
            public void menuSelected(int index, eventCallBack callBack) {
                if (index != selectedIndex) {
                    menuBanHang.this.callBack = callBack;
    ...
    private void initData() {
        ...
        listMenu.addItem(new model_menu("3", "Giỏ hàng", model_menu.MenuType.MENU));
        listMenu.addItem(new model_menu("4", "Đơn hàng", model_menu.MenuType.MENU));
        listMenu.addItem(new model_menu("5", "Đánh giá", model_menu.MenuType.MENU));
        listMenu.addItem(new model_menu("6", "Đơn hàng đã hủy", model_menu.MenuType.MENU));
        listMenu.addItem(new model_menu("7", "Tài khoản", model_menu.MenuType.MENU));
        listMenu.addItem(new model_menu("8", "Trợ giúp", model_menu.MenuType.MENU));
